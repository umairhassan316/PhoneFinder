...
@Entity(tableName = "audio_items_claps")
public class AudioModelClapsDatabase implements Serializable {
    ...
    public static AudioModelClapsDatabase fromByteArray(byte[] byteArray) throws IOException, ClassNotFoundException {
        // Convert the byte array back to an AudioModel object
        ByteArrayInputStream inputStream = new ByteArrayInputStream(byteArray);
        ObjectInputStream objectInputStream = new ObjectInputStream(inputStream);
        return (AudioModelClapsDatabase) objectInputStream.readObject();
    }


    public AudioModelClapsDatabase() {
    }

    public AudioModelClapsDatabase(boolean flashLight, boolean vibration, boolean sound, int soundSeekbar, String title, String imageResourceId, int audioResourceId, int timeDurationService) {
