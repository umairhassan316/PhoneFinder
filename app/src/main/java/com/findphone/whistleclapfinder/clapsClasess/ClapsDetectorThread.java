...
import static com.findphone.whistleclapfinder.clapsClasess.utils.MyUtils.seekbarFun;
import static com.findphone.whistleclapfinder.clapsClasess.utils.MyUtils.soundDisableEnableFun;
import static com.findphone.whistleclapfinder.clapsClasess.utils.MyUtils.timeDurationstopServiceAfterComplete;
import static com.findphone.whistleclapfinder.clapsClasess.utils.MyUtils.useForAudioMode;
import static com.findphone.whistleclapfinder.clapsClasess.utils.MyUtils.whenWhistleOrClapsDetectScreenLightOn;
...
public class ClapsDetectorThread extends Thread {
    ...
    private ClapsRecorderThread recorder;
    ...
    public ClapsDetectorThread(ClapsRecorderThread recorder, Context detectionService) {
...
//                        SharedPreferences sharedPreferences = context.getSharedPreferences("MyPreferencesSelectItemClaps", Context.MODE_PRIVATE);
...
//
//                                Log.d("checksound11111", "if (isWhistle){");
//
...
//                                Log.d("checksound11111", "whistleDetected = true;");
//
//
//                            }else {
...
//                    // end whistle detection
                    ...
                    try {
                        ...
                        Log.d("checksound", "isWhistle : " + isClaps + " " + buffer.length);
                        /* Below shared prefrence use becuse if user selected tune apply whan user speak whistle to start tune*/
                        SharedPreferences sharedPreferences = context.getSharedPreferences("MyPreferencesSelectItemClaps", MODE_PRIVATE);
                        Boolean isRingTuneSelected = sharedPreferences.getBoolean("isRingTuneSelected", false);
                        ...
                        // Inside your detection logic, check the flag before running the code.
                        // Move the flag reset logic outside of the if block
                        if (isRingTuneSelected && isClaps && !whistleDetected) {
                            Log.d("checksound", "isWhistle Sound here and if mobile silent then set normal mode and flash litgh blinking");

                            Log.d("checksound1111111111", "if (isWhistle){");
...
//
                            ...
                            // Set the flag to true to indicate that the code has been executed.
                            whistleDetected = true;
                            Log.d("checksdferound1111111111", "claps Detected = true;");


                            // below thread into use handler for whistleDetected boolean set this use reason of claps detect fist time then true and thread into hander set whistleDetected then false means again claps detect is ready
