...
public class RippleBackground extends RelativeLayout {
    ...
    private static ArrayList<RippleView> rippleViewList=new ArrayList<RippleView>();
    ...
    public static void startRippleAnimation(){
    ...
    public static boolean isRippleAnimationRunning(){
