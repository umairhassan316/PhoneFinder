...
import com.findphone.whistleclapfinder.R; // Replace with your app's package name
import com.findphone.whistleclapfinder.activity.HomeActivity;

public class WhistleForegroundService extends Service implements WhistleDetectorThread.OnWhistleListener {
...
//                                startWhistleDetection();
//
//                                Log.d("checksound111wff1111111", "  Whistle Forground Detection Service startWhistleDetection();");
//
//                            }
//                        },2000);
